return {
  { 'ThePrimeagen/vim-be-good',   event = { "LazyFile" }, },   -- Game for getting better at Vim
  { 'frazrepo/vim-rainbow',       event = { "LazyFile" }, },   -- Add the indentation colors to different indentation level
